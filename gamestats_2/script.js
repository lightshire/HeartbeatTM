                ...
                return (<div>
                            ...
                            <div className='fields'>
                                    ...
                                    <div className='diablo3 row'>
                                        ...
                                        <div className="col s8">
                                            <div className="input-field">
                                                <input id="diablo3_username" type="text" className="fields validate"/>
                                                <label htmlFor="diablo3_username">Battle Tag in name-#### format (ie. Noob-1234)</label>
                                            </div>
                                        </div>
